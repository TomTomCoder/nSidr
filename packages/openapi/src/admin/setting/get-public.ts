...
import { chatModelSchema, llmProviderSchema, modelConfigSchema } from './update';

// Strip per-model apiKey from the public schema (T-15-01 — Information Disclosure mitigation)
// Provider-level apiKey is already excluded by the .pick() below.
