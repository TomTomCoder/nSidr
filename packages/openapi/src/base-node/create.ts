...
const createBaseAgentNodeRoSchema = z.object({
  ...createBaseNodeSchema.shape,
  resourceType: z.literal(BaseNodeResourceType.Agent),
  resourceId: z.string().optional(),
});

export type ICreateAgentNodeRo = z.infer<typeof createBaseAgentNodeRoSchema>;
