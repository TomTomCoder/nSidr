...
export interface IRecordMenu {
  ...
  addToChat?: () => void;
  // Phase 16-04 — single-cell context (only populated for single-row right-click on a specific cell)
  // Used to render the AI "Regenerate" item gated by FieldType.Ai.
