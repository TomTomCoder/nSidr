...
export const ReactQueryKeys = {
  ...
  workflowList: (baseId: string) => ['workflow-list', baseId] as const,

  workflowItem: (baseId: string, workflowId: string) =>
    ['workflow-item', baseId, workflowId] as const,

  workflowRuns: (baseId: string, workflowId: string) =>
    ['workflow-runs', baseId, workflowId] as const,

  appList: (baseId: string) => ['app-list', baseId] as const,

  getApp: (baseId: string, appId: string) => ['app', baseId, appId] as const,

  appContent: (baseId: string, appId: string) => ['app-content', baseId, appId] as const,
  ...
  authorityMatrix: (baseId: string, matrixId: string) =>
    ['authority-matrix', baseId, matrixId] as const,
};
