  ...
  return new QueryClient({
    defaultOptions: {
      queries: {
        ...
        // 60s: most data changes only on user action, not on a timer.
        staleTime: 60 * 1000,
        // Disable window-focus refetch globally — prevents a burst of background
        // API calls every time the user alt-tabs back. Override per-query where
