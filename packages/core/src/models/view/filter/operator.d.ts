...
export declare const dateRange: z.ZodLiteral<"dateRange">;
...
export declare const symbols: z.ZodUnion<readonly [z.ZodLiteral<"=">, z.ZodLiteral<"!=">, z.ZodLiteral<">">, z.ZodLiteral<">=">, z.ZodLiteral<"<">, z.ZodLiteral<"<=">, z.ZodLiteral<"LIKE">, z.ZodLiteral<"IN">, z.ZodLiteral<"HAS">, z.ZodLiteral<"NOT LIKE">, z.ZodLiteral<"NOT IN">, z.ZodLiteral<"IS NULL">, z.ZodLiteral<"IS NOT NULL">]>;
export type ISymbol = z.infer<typeof symbols>;
export declare const textFieldOperators: z.ZodUnion<readonly [z.ZodLiteral<"is">, z.ZodLiteral<"isNot">, z.ZodLiteral<"contains">, z.ZodLiteral<"doesNotContain">, z.ZodLiteral<"isEmpty">, z.ZodLiteral<"isNotEmpty">]>;
...
export declare const numberFieldOperators: z.ZodUnion<readonly [z.ZodLiteral<"is">, z.ZodLiteral<"isNot">, z.ZodLiteral<"isGreater">, z.ZodLiteral<"isGreaterEqual">, z.ZodLiteral<"isLess">, z.ZodLiteral<"isLessEqual">, z.ZodLiteral<"isEmpty">, z.ZodLiteral<"isNotEmpty">]>;
export type INumberFieldOperator = z.infer<typeof numberFieldOperators>;
export declare const numberFieldValidOperators: ("isEmpty" | "is" | "isNot" | "isGreater" | "isGreaterEqual" | "isLess" | "isLessEqual" | "isNotEmpty")[];
...
export declare const dateTimeFieldOperators: z.ZodUnion<readonly [z.ZodLiteral<"is">, z.ZodLiteral<"isNot">, z.ZodLiteral<"isWithIn">, z.ZodLiteral<"isBefore">, z.ZodLiteral<"isAfter">, z.ZodLiteral<"isOnOrBefore">, z.ZodLiteral<"isOnOrAfter">, z.ZodLiteral<"isEmpty">, z.ZodLiteral<"isNotEmpty">]>;
...
export declare const dateTimeFieldSubOperators: z.ZodUnion<readonly [z.ZodLiteral<"today">, z.ZodLiteral<"tomorrow">, z.ZodLiteral<"yesterday">, z.ZodLiteral<"currentWeek">, z.ZodLiteral<"lastWeek">, z.ZodLiteral<"nextWeekPeriod">, z.ZodLiteral<"currentMonth">, z.ZodLiteral<"lastMonth">, z.ZodLiteral<"nextMonthPeriod">, z.ZodLiteral<"currentYear">, z.ZodLiteral<"lastYear">, z.ZodLiteral<"nextYearPeriod">, z.ZodLiteral<"oneWeekAgo">, z.ZodLiteral<"oneWeekFromNow">, z.ZodLiteral<"oneMonthAgo">, z.ZodLiteral<"oneMonthFromNow">, z.ZodLiteral<"daysAgo">, z.ZodLiteral<"daysFromNow">, z.ZodLiteral<"exactDate">, z.ZodLiteral<"exactFormatDate">, z.ZodLiteral<"dateRange">]>;
export type IDateTimeFieldSubOperator = z.infer<typeof dateTimeFieldSubOperators>;
export declare const dateTimeFieldValidSubOperators: ("today" | "tomorrow" | "yesterday" | "currentWeek" | "lastWeek" | "nextWeekPeriod" | "currentMonth" | "lastMonth" | "nextMonthPeriod" | "currentYear" | "lastYear" | "nextYearPeriod" | "oneWeekAgo" | "oneWeekFromNow" | "oneMonthAgo" | "oneMonthFromNow" | "daysAgo" | "daysFromNow" | "exactDate" | "exactFormatDate" | "dateRange")[];
export declare const dateTimeFieldSubOperatorsByIsWithin: z.ZodUnion<readonly [z.ZodLiteral<"today">, z.ZodLiteral<"tomorrow">, z.ZodLiteral<"yesterday">, z.ZodLiteral<"currentWeek">, z.ZodLiteral<"lastWeek">, z.ZodLiteral<"nextWeekPeriod">, z.ZodLiteral<"currentMonth">, z.ZodLiteral<"lastMonth">, z.ZodLiteral<"nextMonthPeriod">, z.ZodLiteral<"currentYear">, z.ZodLiteral<"lastYear">, z.ZodLiteral<"nextYearPeriod">, z.ZodLiteral<"oneWeekAgo">, z.ZodLiteral<"oneWeekFromNow">, z.ZodLiteral<"oneMonthAgo">, z.ZodLiteral<"oneMonthFromNow">, z.ZodLiteral<"daysAgo">, z.ZodLiteral<"daysFromNow">, z.ZodLiteral<"exactDate">, z.ZodLiteral<"exactFormatDate">, z.ZodLiteral<"pastWeek">, z.ZodLiteral<"pastMonth">, z.ZodLiteral<"pastYear">, z.ZodLiteral<"nextWeek">, z.ZodLiteral<"nextMonth">, z.ZodLiteral<"nextYear">, z.ZodLiteral<"pastNumberOfDays">, z.ZodLiteral<"nextNumberOfDays">]>;
export type IDateTimeFieldSubOperatorByIsWithin = z.infer<typeof dateTimeFieldSubOperatorsByIsWithin>;
export declare const dateTimeFieldValidSubOperatorsByIsWithin: ("today" | "tomorrow" | "yesterday" | "currentWeek" | "lastWeek" | "nextWeekPeriod" | "currentMonth" | "lastMonth" | "nextMonthPeriod" | "currentYear" | "lastYear" | "nextYearPeriod" | "oneWeekAgo" | "oneWeekFromNow" | "oneMonthAgo" | "oneMonthFromNow" | "daysAgo" | "daysFromNow" | "exactDate" | "exactFormatDate" | "pastWeek" | "pastMonth" | "pastYear" | "nextWeek" | "nextMonth" | "nextYear" | "pastNumberOfDays" | "nextNumberOfDays")[];
export declare function getFilterOperatorMapping(field: {
    ...
    isWithIn: "IS WITH IN";
}, "isEmpty" | "is" | "isNot" | "contains" | "doesNotContain" | "isGreater" | "isGreaterEqual" | "isLess" | "isLessEqual" | "isNotEmpty" | "isAnyOf" | "isNoneOf" | "hasAnyOf" | "hasAllOf" | "isNotExactly" | "hasNoneOf" | "isExactly" | "isWithIn" | "isBefore" | "isAfter" | "isOnOrBefore" | "isOnOrAfter">;
/**
