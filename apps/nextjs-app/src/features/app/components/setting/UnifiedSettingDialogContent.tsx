...
import { Puzzle, Settings2, Users } from 'lucide-react';
...
import { ExtensionPage } from '@/features/app/blocks/space-setting/integration/ExtensionPage';
...
export const UnifiedSettingDialogContent = ({
  ...
  const spaceTabs = useMemo<IUnifiedSettingListItem[]>(() => {
    ...
    return [
      ...
      {
        key: SpaceSettingTab.Extensions,
        name: 'Extensions',
        Icon: Puzzle,
        content: ({ resolvedSpaceId }) =>
          resolvedSpaceId ? <ExtensionPage spaceId={resolvedSpaceId} /> : null,
      },
      ...(extraSpaceTabs ?? []),
    ];
