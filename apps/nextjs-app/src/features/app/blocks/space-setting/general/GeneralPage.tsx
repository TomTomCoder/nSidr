          ...
          <div className="flex h-full flex-col justify-between">
            <div className="flex flex-col gap-y-4">
              ...
              <div className="w-full sm:max-w-sm">
                <p className="mb-1.5 text-sm font-medium">{t('space:spaceSetting.spaceId')}</p>
            ...
            {hasPermission(space.role, 'space|delete') && (
              <div className="mt-8 rounded-lg border border-destructive/30 bg-destructive/5 p-4">
                <h3 className="mb-1 text-sm font-semibold text-destructive">Zone de danger</h3>
                <p className="mb-3 text-xs text-muted-foreground">
                  La suppression de cet espace est irréversible. Toutes les bases et données
                  associées seront perdues.
                </p>
                <Button
                  variant="outline"
                  size="sm"
                  className="w-fit border-destructive/50 text-destructive hover:bg-destructive hover:text-destructive-foreground"
