...
import { Plus, Settings, Trash2, LayoutTemplate, FileDocument } from '@teable/icons';
...
export const SpaceInnerSideBar = (props: {
  ...
  const templateCtxValue = useMemo(() => ({ spaceId }), [spaceId]);
    ...
    <>
      <div className="flex flex-col justify-center px-2">
        ...
        <ul className="py-1">
          ...
          <li key="template">
            <TemplateContext.Provider value={templateCtxValue}>
          ...
          <li key="doc-library">
            <Button
              ...
              onClick={() => {
                router.push({
                  pathname: '/space/[spaceId]/doc-library',
                  query: { spaceId },
                });
              }}
            >
              <FileDocument className="size-4 shrink-0" />
              <p className="truncate">Doc Library</p>
            </Button>
          </li>
        </ul>
      </div>
