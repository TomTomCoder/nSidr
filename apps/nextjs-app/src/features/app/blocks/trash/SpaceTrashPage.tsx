...
export const SpaceTrashPage = () => {
  ...
  return (
    <div className="flex h-screen flex-1 flex-col space-y-4 overflow-hidden p-8">
      ...
      <Tabs defaultValue="spaces" className="flex min-h-0 flex-1 flex-col overflow-hidden">
        <TabsList className="w-fit shrink-0">
          <TabsTrigger value="spaces">{t('common:noun.space')}</TabsTrigger>
          <TabsTrigger value="bases">{t('common:noun.base')}</TabsTrigger>
          <TabsTrigger value="tables">{t('common:noun.table')}</TabsTrigger>
        </TabsList>

        <TabsContent value="spaces" className="mt-4 min-h-0 flex-1 overflow-auto">
        ...
        <TabsContent value="bases" className="mt-4">
          <p className="text-sm text-muted-foreground">
            {t('common:trash.basesHint', {
              defaultValue:
                "Pour voir les bases supprimées, utilisez l'icône corbeille depuis votre espace (barre latérale).",
            })}
          </p>
        </TabsContent>
        ...
        <TabsContent value="tables" className="mt-4">
          <p className="text-sm text-muted-foreground">
            {t('common:trash.tablesHint', {
              defaultValue:
                "Pour voir les tables supprimées, utilisez l'icône corbeille depuis votre base (onglet Tables).",
            })}
          </p>
        </TabsContent>
      </Tabs>
