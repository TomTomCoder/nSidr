...
export class TrashService {
  ...
  private async getSpaceTrash() {
    ...
    // Defensive cap: trash UI shows the most-recent items. A user with very large
    // trash history could otherwise load thousands of rows in one request.
    // TODO: proper cursor pagination when the trash list gains an "older →" affordance.
