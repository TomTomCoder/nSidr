...
import { UnifiedAiModule } from './features/ai/unified-ai.module';
import { AppBuilderModule } from './features/app-builder/app-builder.module';
...
import { DocSearchModule } from './features/doc-search/doc-search.module';
...
import { FieldPermissionModule } from './features/field-permission/field-permission.module';
...
import { OAuthIntegrationModule } from './features/oauth-integration/oauth-integration.module';
import { UserIntegrationModule } from './features/user-integration/user-integration.module';
...
import { VerifiedDomainModule } from './features/verified-domain/verified-domain.module';
...
// 30s for prod: Redis is normally fast but Docker startup order can add delay;
// 5s caused silent BullMQ module skip when Redis was briefly slow to accept connections.
const CONDITIONAL_MODULE_TIMEOUT = isTestOrCI ? 60000 : 30000;
